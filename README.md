...
- `docs/BOUNDARY_SPEC_SCHEMA_REGISTRY_QUERY_CATALOG_GOVERNANCE.md` - boundary specification outputs and follow-on proposals for schema/query governance
- `docs/GAP_ANALYSIS_SCHEMA_REGISTRY_QUERY_CATALOG_GOVERNANCE.md` - gap analysis outputs, dependencies, and non-execution follow-on proposals for schema/query governance
